      ...
      content: (
        <div>
          <h1 className="text-neutral-800 dark:text-neutral-200  font-extrabold mb-8">
            Completed my tenure at Microsoft Learn Ambassador after hosting sessions on Git and Github as well as Web dev.
          </h1>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/images/mlsa1.jpg"
